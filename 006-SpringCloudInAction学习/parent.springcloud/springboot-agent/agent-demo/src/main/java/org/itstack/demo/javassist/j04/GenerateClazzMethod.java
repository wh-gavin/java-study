package org.itstack.demo.javassist.j04;
...
public class GenerateClazzMethod extends ClassLoader {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 方法后加强
        ctMethod.insertAfter("{ org.itstack.demo.javassist.j04.Monitor.point(" + idx + ", startNanos, parameterValues, $_);}", false); // 如果返回类型非对象类型，$_ 需要进行类型转换

        // 方法；添加TryCatch
        ctMethod.addCatch("{ org.itstack.demo.javassist.j04.Monitor.point(" + idx + ", $e); throw $e; }", ClassPool.getDefault().get("java.lang.Exception"));   // 添加异常捕获
        ...
        Class<?> clazzNew = new GenerateClazzMethod().defineClass("org.itstack.demo.javassist.j04.ApiTest", bytes, 0, bytes.length);
