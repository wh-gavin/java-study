...
public class HelloWorld {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建类信息
        CtClass ctClass = pool.makeClass("org.itstack.demo.javassist.HelloWorld1");
        ...
        Annotation clazzAnnotation = new Annotation("org/itstack/demo/bytecode/j01/RpcGatewayClazz", cp);
        ...
        Annotation methodAnnotation = new Annotation("org/itstack/demo/bytecode/j01/RpcGatewayMethod", cp);
